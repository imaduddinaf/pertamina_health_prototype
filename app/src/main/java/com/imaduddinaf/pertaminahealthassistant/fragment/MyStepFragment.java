...
import com.imaduddinaf.pertaminahealthassistant.core.StepCountReader;
...
//        runOnUiThread(() -> tvStepCount.setText(count));
        Log.d(Helper.DEBUG_TAG, "step count: " + count);
        Log.d(Helper.DEBUG_TAG, "tvStepCount1: " + tvStepCount.getText());
        tvStepCount.setText(count);
        Log.d(Helper.DEBUG_TAG, "tvStepCount2: " + tvStepCount.getText());
    }
